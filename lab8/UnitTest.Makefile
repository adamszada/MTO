...
.SILENT all:
	...
	$(call perform_test,alphaNumeric,alphaNumeric)
	$(call perform_test,plausible,"Edge cases")
	$(call perform_test,invalid,"Input invalid")
	$(call perform_test,valid,"Input valid")
...
generate:
	...
	$(call generate_answers,alphaNumeric)
	$(call generate_answers,plausible)
...
merge:
	...
	$(call merge_test,alphaNumeric)
	$(call merge_test,plausible)
